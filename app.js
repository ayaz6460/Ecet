...
function exportRankFinderToPDF() {
    ...
    doc.text("RankMaster Portal - Eligible Colleges List", 14, 15);
    ...
    doc.autoTable({
        ...
        didDrawPage: function(data) {
            ...
            doc.text("Generated By RankMaster Portal Based on 2025 Ecet admission data Developed By NotAyaz...", doc.internal.pageSize.width - 14, doc.internal.pageSize.height - 10, { align: "right" });
        }
    });
